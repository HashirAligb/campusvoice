...
export default function IssueDetail() {
        ...
        try {
            ...
            if (commentsFetchError) {
                if (
                    ...
                    setCommentsError("Comments are not available yet. Please set up the database table.");
                    setComments([]);
                    return;
                }
            ...
            const authorIds = [
                ...new Set(rawComments.map((comment) => comment.author_id).filter(Boolean)),
            ] as string[];
    ...
    const handleSubmitComment = async (event: React.FormEvent) => {
        ...
        try {
            ...
            setCommentsError(
                err.message ?? "Unable to submit your comment right now. Please try again later."
            );
        } finally {
        ...
        return (
            <div className="min-h-screen bg-[#0d1017] text-white">
                ...
                <div className="max-w-3xl mx-auto py-20 px-4">
                    <p className="text-red-400 mb-4">{error || "Issue not found."}</p>
                    <button
                ...
                <section className="mt-10">
                    ...
                    <form className="mt-6" onSubmit={handleSubmitComment}>
                        <textarea
                            ...
                            placeholder={
                                user ? "Share your thoughts..." : "Log in to join the conversation."
                            }
