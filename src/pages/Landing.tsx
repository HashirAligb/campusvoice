        ...
        <div className="min-h-screen flex flex-col">
            ...
            <div className="flex-1 flex flex-col items-center justify-center bg-[url('/bg5.png')] bg-cover bg-position-[center_10%]">
                <div className="translate-y-[-45px] text-center">
                    ...
                    <p className="animate-fade-in-up [animation-delay:500ms] mt-1 text-xl font-semibold text-white tracking-tight">
                        Your Campus, Your Voice
                    </p>
                    <p className="animate-fade-in-up [animation-delay:1000ms] mt-4 text-2xl font-semibold text-white max-w-4xl">
                    ...
                    <div className="flex text-center justify-center space-x-4">
                        <button onClick={() => { if (!isLoggedIn) { navigate("/Login") } else navigate("/Home") }}
                            className="animate-fade-in-up [animation-delay:1500ms] mt-4 px-5 py-2 bg-green-500 text-white text-xl font-semibold rounded-lg shadow-xl
